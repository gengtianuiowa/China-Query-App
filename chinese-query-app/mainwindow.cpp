...
//         qDebug()<<chname2<<endl;
        ...
        if (myfile.LoadFile())//启用读取函数
        {
            ...
            //myfile.Database.GEOLayer->GEOObject->ShowObject();
...
//void MainWindow::on_confirmSearching_2_clicked()
//{
//    this->findcityname=false;
//    QString inputX=ui->inputX->text();
//    QString inputY=ui->inputY->text();
//    int x=inputX.toInt();
//    int y=inputY.toInt();
//    if(myfile.txtState==true)
//    {
//        findcityname=myfile.findInindex(x,y);
//        if(this->findcityname==false)
//            {
//                cout<<inputX.toInt()<<","<<inputY.toInt()<<" has not been found."<<endl;
//            }
//        else
//            {
//                //string outputcity;
//               // QTextCodec* code = QTextCodec::codecForName("gb2312");
//                //if (code)// 如果code为0，表示在运行的机器上没有装gb2312字符集。不过一般的中文windows系统中都安装了这一字符集
//                //outputcity= code->fromUnicode(myfile.cityFromindex.CityName).data();
//                cout<<myfile.cityFromindex.CityName<<" has been found."<<endl;
//            }
//    }
//    else
//        cout<<"You need load the file first."<<endl;
//}


//void MainWindow::paintEvent(QPaintEvent *)
//{
//    QPainter p(this->ui->label_6);
